  ...
  switch (signature) {
    ...
    case 't':
      ...
      marshaller.marshall = function(ps, data) {
        ...
        align(ps, 8);
        let word0 = JSBI.subtract(data, JSBI.leftShift(JSBI.signedRightShift(data, JSBI.BigInt(32)), JSBI.BigInt(32)));
        let word1 = JSBI.signedRightShift(data, JSBI.BigInt(32));
    ...
    case 'x':
      ...
      marshaller.marshall = function(ps, data) {
        data = this.check(data);
        let isNegative = (JSBI.lessThan(data, JSBI.BigInt(0)));
        if (isNegative) {
        ...
        if (isNegative) {
          word1 = JSBI.bitwiseOr(word1, JSBI.leftShift(JSBI.BigInt(1), JSBI.BigInt(31)));
        }
