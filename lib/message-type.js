 ...
 * @param {messageType} [options.type=METHOD_CALL]
 ...
 * @param {string} [options.signature=''] - The signature of the message body.
 ...
 * @param {messageFlag} [options.flags]
 */
class Message {
  /**
  ...
  constructor(msg) {
    /**
     * @member {messageType} - The type of message this is. Either METHOD_CALL,
