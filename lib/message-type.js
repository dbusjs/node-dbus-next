 ...
 * @param {MessageType} [options.type={@link MESSAGE_TYPE_METHOD_CALL}]
...
class Message {
  ...
  constructor(msg) {
    /**
     * @member {MessageType} - The type of message this is. Either {@link
     * MESSAGE_TYPE_METHOD_CALL}, {@link MESSAGE_TYPE_METHOD_RETURN}, {@link
     * MESSAGE_TYPE_SIGNAL}, or {@link MESSAGE_TYPE_ERROR}.
     */
    ...
    this.body = msg.body || [];
    /**
     * @member {MessageFlags} - The flags for this message. Can be a
     * combination of {@link MESSAGE_FLAG_NO_REPLY_EXPECTED} and {@link
     * MESSAGE_FLAG_NO_AUTO_START}
     */
