 ...
 * of requesting a service {@link Name} to export an [`Interface`]{@link
 * module:interface~Interface}, or getting a proxy object to interact with
 * an existing name on the bus as a client. A `MessageBus` is created with
 * `dbus.sessionBus()` or `dbus.systemBus()` methods of the dbus-next module.
 *
...
class MessageBus extends EventEmitter {
  ...
  /**
   * Request a well-known {@link Name} on the bus. The `Name` can be used to export
   * an [`Interface`]{@link module:interface~Interface} at an object path on
   * the name. If the name is already taken and {@link
   * DBUS_NAME_FLAG_DO_NOT_QUEUE} is given, the method may throw a {@link
   * NameExistsError}. See {@link DBUS_NAME_FLAG_ALLOW_REPLACEMENT} and {@link
   ...
   * @returns {Promise} - a Promise that resolves with the {@link Name}.
   */
