 ...
 * of requesting a service `Name` to export an [`Interface`]{@link
...
class MessageBus extends EventEmitter {
  ...
  /**
   * Request a well-known `Name` on the bus. The `Name` can be used to export
   ...
   * @returns {Promise} - a Promise that resolves with the `Name`.
   */
