...
class MessageBus extends EventEmitter {
  ...
  constructor(conn) {
    ...
    this._sendMethodCall(helloMessage)
      .then((msg) => {
  ...
  requestName(name, flags) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this._sendMethodCall(requestNameMessage)
        .then((msg) => {
  ...
  _sendMethodCall(msg) {
    return new Promise((resolve, reject) => {
      if (!msg.type) {
        msg.type = constants.messageType.METHOD_CALL;
      }
  ...
  _sendMethodReturn(msg, signature, body) {
    this._connection.message({
  ...
  _addMatch(match) {
    ...
    return this._sendMethodCall(msg);
  };
};
